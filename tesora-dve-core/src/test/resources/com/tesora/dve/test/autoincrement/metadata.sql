...
values 
(100, "foo", 1, 2, 3, "InnoDB", "BASE TABLE"),
(200, "bar", 1, 2, 3, "InnoDB", "BASE TABLE");
...
("value", 12, "varchar", 100, 20, 0,  0, 0, 1, 0, 1, 0, null, 1, 0, 0),

("id",     4, "integer", 200,  4, 1, 10, 0, 0, 0, 1, 1, null, 0, 0, 0),
("value", 12, "varchar", 200, 20, 0,  0, 0, 1, 0, 1, 0, null, 1, 0, 0);
