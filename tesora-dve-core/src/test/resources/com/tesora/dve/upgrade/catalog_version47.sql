...
create table user_column (user_column_id integer not null auto_increment, cdv integer, charset varchar(255), collation varchar(255), comment varchar(255), data_type integer not null, default_value longtext, es_universe longtext, flags integer not null, hash_position integer, name varchar(255) not null, native_type_name varchar(255) not null, order_in_table integer not null, prec integer not null, scale integer not null, size integer not null, user_table_id integer, primary key (user_column_id)) ENGINE=InnoDB;
...
create table user_trigger (trigger_id integer not null auto_increment, character_set_client varchar(255) not null, collation_connection varchar(255) not null, database_collation varchar(255) not null, trigger_body longtext not null, trigger_event varchar(255) not null, trigger_name varchar(255) not null, origsql longtext not null, sql_mode longtext not null, trigger_time varchar(255) not null, user_id integer not null, table_id integer not null, primary key (trigger_id)) ENGINE=InnoDB;
