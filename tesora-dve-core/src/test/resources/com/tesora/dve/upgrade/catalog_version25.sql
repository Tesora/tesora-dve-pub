...
create table user_table (table_id integer not null auto_increment, collation varchar(255), comment varchar(2048), create_options varchar(255), create_table_stmt longtext, engine varchar(255) not null, name varchar(255) not null, refs integer, row_format varchar(255), state varchar(255), container_id integer, distribution_model_id integer not null, privtab_ten_id integer, persistent_group_id integer not null, shape_id integer, user_database_id integer not null, primary key (table_id)) ENGINE=InnoDB;
