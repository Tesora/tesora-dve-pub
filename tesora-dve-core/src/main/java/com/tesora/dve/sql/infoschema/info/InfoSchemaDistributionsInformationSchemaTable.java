...
public class InfoSchemaDistributionsInformationSchemaTable extends ComputedInformationSchemaTable {
	...
	public void prepare(AbstractInformationSchema schemaView, DBNative dbn) {
		...
		addColumn(null,new BackedComputedInformationSchemaColumn(InfoView.INFORMATION, dlt.lookup("database_name"), 
				new UnqualifiedName("database_name")));
		addColumn(null,new BackedComputedInformationSchemaColumn(InfoView.INFORMATION, dlt.lookup("table_name"),
				new UnqualifiedName("table_name")));
		addColumn(null,new BackedComputedInformationSchemaColumn(InfoView.INFORMATION, dlt.lookup("column_name"),
				new UnqualifiedName("column_name")));
		addColumn(null,new BackedComputedInformationSchemaColumn(InfoView.INFORMATION, dlt.lookup("dvposition"),
				new UnqualifiedName("vector_position")));
		addColumn(null,new BackedComputedInformationSchemaColumn(InfoView.INFORMATION, dlt.lookup("model_name"),
				new UnqualifiedName("model_type")));
		addColumn(null,new BackedComputedInformationSchemaColumn(InfoView.INFORMATION, dlt.lookup("range_name"),
