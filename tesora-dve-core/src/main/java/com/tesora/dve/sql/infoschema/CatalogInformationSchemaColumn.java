...
public class CatalogInformationSchemaColumn extends LogicalInformationSchemaColumn {
	...
	public CatalogInformationSchemaColumn(InfoSchemaColumn config, Type t, Method getMethod, String columnName,
	...
	public CatalogInformationSchemaColumn(CatalogInformationSchemaColumn given) {
	...
	protected CatalogInformationSchemaColumn(UnqualifiedName columnName, Type type) {
