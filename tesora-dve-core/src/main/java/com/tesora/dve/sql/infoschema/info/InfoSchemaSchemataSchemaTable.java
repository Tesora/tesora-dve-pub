...
public class InfoSchemaSchemataSchemaTable extends
	...
	protected ComputedInformationSchemaColumn nameColumn;
	...
	public void prepare(AbstractInformationSchema schemaView, DBNative dbn) {
		...
		addColumn(null,new ConstantComputedInformationSchemaColumn(InfoView.INFORMATION, new UnqualifiedName("catalog_name"),
				LogicalInformationSchemaTable.buildStringType(dbn, 255), "def"));
		
		nameColumn = new BackedComputedInformationSchemaColumn(InfoView.INFORMATION, schemataTable.lookup("name"), new UnqualifiedName("schema_name")) {
			@Override
		...
		addColumn(null,new BackedComputedInformationSchemaColumn(InfoView.INFORMATION, schemataTable.lookup("default_storage_group"), 
				new UnqualifiedName("default_persistent_group")));
		addColumn(null,new BackedComputedInformationSchemaColumn(InfoView.INFORMATION, schemataTable.lookup("template"), 
				new UnqualifiedName("template")));
		addColumn(null, new BackedComputedInformationSchemaColumn(InfoView.INFORMATION, schemataTable.lookup("template_mode"),
				new UnqualifiedName("template_mode")));
		addColumn(null,new BackedComputedInformationSchemaColumn(InfoView.INFORMATION, schemataTable.lookup("multitenant"), 
				new UnqualifiedName("multitenant")));
		addColumn(null,new BackedComputedInformationSchemaColumn(InfoView.INFORMATION, schemataTable.lookup("fkmode"),
				new UnqualifiedName("fkmode")));
		addColumn(null,new BackedComputedInformationSchemaColumn(InfoView.INFORMATION, schemataTable.lookup("def_character_set_name"), 
				new UnqualifiedName("default_character_set_name")));
		addColumn(null,new BackedComputedInformationSchemaColumn(InfoView.INFORMATION, schemataTable.lookup("def_collation_name"), 
