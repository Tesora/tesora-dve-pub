...
public class FunctionStatusInformationSchemaTable extends LogicalInformationSchemaTable {

	public static final String TABLE_NAME = "FUNCTION STATUS";

	private LogicalInformationSchemaColumn dbColumn;

	public FunctionStatusInformationSchemaTable(DBNative dbn) {
