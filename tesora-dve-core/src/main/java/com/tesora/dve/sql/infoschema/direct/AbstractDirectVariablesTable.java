...
public abstract class AbstractDirectVariablesTable extends DirectInformationSchemaTable {
	...
	public AbstractDirectVariablesTable(SchemaContext sc, InfoView view,
	...
	public static Statement execute(SchemaContext sc, AbstractDirectVariablesTable tab, VariableScope vs, ViewQuery vq, ProjectionInfo pi) {
	...
	public static IntermediateResultSet executeLikeSelect(SchemaContext sc,
		...
		ColumnSet cs = 
				LogicalSchemaQueryEngine.buildProjectionMetadata(sc, cols, pi, Collections.EMPTY_LIST);
