...
JAVA_ARGS="-Dlog4j.configuration=analyzerlog4j.properties -Dtesora.dve.log=$LOG_DIR"

"$JAVA_PROG" -classpath $CLASSPATH $JAVA_ARGS com.tesora.dve.tools.DVEAnalyzerCLI "$@"
