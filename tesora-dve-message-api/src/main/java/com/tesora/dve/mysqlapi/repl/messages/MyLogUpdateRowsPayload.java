 ...
 *
 */
public class MyLogUpdateRowsPayload extends MyLogEventPacket {
    ByteBuf heapBuffer;

    public MyLogUpdateRowsPayload(MyReplEventCommonHeader ch) {
        super(ch);
    }

    @Override
    public void accept(ReplicationVisitorTarget visitorTarget) throws PEException {
        visitorTarget.visit((MyLogUpdateRowsPayload)this);
    }
