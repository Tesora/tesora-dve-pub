 ...
 *
 */
public class MyLogDeleteRowsPayload extends MyLogEventPacket {
    ByteBuf heapBuffer;

    public MyLogDeleteRowsPayload(MyReplEventCommonHeader ch) {
        super(ch);
    }

    @Override
    public void accept(ReplicationVisitorTarget visitorTarget) throws PEException {
        visitorTarget.visit((MyLogDeleteRowsPayload)this);
    }
    ...
    public String toString(){
        return String.format("MyLogUpdateRowsPayload[header=%s, buffer=%s]",this.ch,heapBuffer);
    }
}
